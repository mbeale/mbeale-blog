...
* You will also want to pick something you can measure today or add the signal easily. It will invalidate the exercise if half the signals you find essential are not possible to measure.
